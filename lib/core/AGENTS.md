...
```
core/
├── models/          # 16 data models (FishCatch, Equipment, etc.)
├── providers/       # 21 Riverpod providers/notifiers
├── services/       # 34 files (business logic + 13 AI adapters in services/adapters/)
...
- **AI providers**: 13 implementations in `services/adapters/` (openai, claude, gemini, minimax, aliyun, tencent, etc.)
...
- AI recognition has pluggable provider architecture in `services/adapters/`
